                    ...
                    {infoCardHome.map((itemCard: infoCard, index: number) => {
                        return (
                            <Grid lg={3} md={4} xs={12} key={itemCard.title} sx={{ display: "flex", justifyContent: "center" }}>
                                <Fade delay={index * 500} cascade damping={1e-1} style={{ zIndex: 10 + index, position: "relative", width: "100%", display: "flex", justifyContent: "center" }}>

                                    <Paper sx={{ background: "#FB8423", display: "flex", width: "90%", height: "190px", cursor: "pointer", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center", padding: "10px", borderRadius: "15px" }} elevation={12}>
                                        <Box component="img"
